...
public class Hamburger {
    ...
    public void setAdditions(Additions additions, int hamburgerType) {
        int additionsLength = 0;
        ...
        if (this.additions.size() < additionsLength) {
            this.additions.add(additions);
            for (int i = 0; i < this.additions.size(); i++) {
                this.price += this.additions.get(i).getPrice();
            }
        }
    }
